      ...
      tabs = {
        {
          label = "General",
          fields = {
            crap.fields.text({ name = "site_name", required = true, default_value = "Crap Studio" }),
        ...
        },
        {
          ...
          fields = {
            crap.fields.group({
              name = "social",
              fields = {
                crap.fields.text({ name = "github", admin = { placeholder = "https://github.com/crap" } }),
                crap.fields.text({ name = "twitter", admin = { placeholder = "https://twitter.com/crap" } }),
                crap.fields.text({
                  name = "linkedin",
                  admin = { placeholder = "https://linkedin.com/company/crap" },
                }),
                crap.fields.text({ name = "instagram", admin = { placeholder = "https://instagram.com/crap" } }),
                crap.fields.text({ name = "youtube", admin = { placeholder = "https://youtube.com/@crap" } }),
              },
            }),
          },
        },
